...
#input = DATA.readlines.map &:strip
...
needed_space = 30_000_000 - (70_000_000 - $root.size_recursive)

p ObjectSpace.each_object(Directory).to_a.select{_1.size_recursive >= needed_space}.sort_by(&:size_recursive).first.size_recursive
